...
class Raio2 extends Component {
    ...
    render() {
        imgUrl = this.props.hightlight ? this.props.seledImg : this.props.selImg;
        imgUrlNone = this.props.selnoneImg;
        return (
            <TouchableHighlight
                underlayColor='transparent'
                style={[{ marginRight: 15, width: (width - 200) / 2, height: 30 }, this.props.initStyle]}
                onPress={this.click.bind(this, this.props.value, this.props.child)}>
                <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }} >
                    {this.props.disabled && !this.props.hightlight && <Image source={imgUrlNone} style={{ width: 20, height: 20, marginRight: 7 }} />}
                    {this.props.disabled && this.props.hightlight && <Image source={imgUrl} style={{ width:20, height: 20, marginRight: 7 }} />}
                    {!this.props.disabled && <Image source={imgUrl} style={{ width: 20, height: 20, marginRight: 7 }} />}
